clear all
[t Y]= ode45('thrustconstante',[0:100:63000],[278626*9.81;0],'RelTol',1e-5,'AbsTol',1e-7);
S=395.88;
rho=0.3639;
gamma=1.4;
np=1;
...
v=zeros(length(t),1);
for i=1:length(t)
    v(i)=vri*sqrt(thrust*Em/(278626*9.81)+(sqrt((thrust*Em/(278626*9.81))^2-(Y(i,1)/(278626*9.81))^2)));
end
M0=v/a0;
%%%%%%%%%%%%%%%%%%%%%%%%%%
